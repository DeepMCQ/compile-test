...
song : main.cu kernelgraph.h
	...
	-std=c++11 main.cu -lcublas -g -O3 -ccbin=$(CXX) -o song -Xptxas -O3,-v \
	-D$(DISTTYPE) \
	-D__ENABLE_FIXHASH -D__ENABLE_VISITED_DEL #-D__ENABLE_FIXHASH -D__ENABLE_VISITED_DEL #-D__ENABLE_FIXHASH -D__ENABLE_VISITED_DEL #.-D__ENABLE_CUCKOO_FILTER -D__ENABLE_VISITED_DEL #-D__ENABLE_FIXHASH # -D__ENABLE_FIXHASH -D__ENABLE_VISITED_DEL
